...
User Request:
{request['item']} ({request['quantity']} units) needed in {request['location']} within {request['days_needed']} days.

Top Vendors:
{vendor_lines}

Suggest the best-fit vendor with a brief comparison and reasoning.
"""
